...
$string ['privacy:metadata:vpl_submissions'] = 'Information on the attempt/submission and on its evaluation if it was done';
...
$string ['privacy:metadata:vpl_assigned_variations:variation'] = 'Variation id';
$string ['privacy:metadata:vpl_running_processes:start_time'] = 'Start time of process';
